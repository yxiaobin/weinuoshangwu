                ...
                <div class="card-body">
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group" >
                            ...
                            <input type="text"  id="linkname" class="form-control" name="linkname">
                        </div>
                        <div class="form-group"  >
                            <label>超链接（根据别名自动生成）</label>
                            <input type="text" id="link"  class="form-control" readonly name="link" value="">
                        </div>
                        {{--<div class="form-group">--}}
