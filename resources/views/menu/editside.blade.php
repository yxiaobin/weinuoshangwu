    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                @endif
                <div class="card-header">编辑侧边导航栏</div>
                <div class="card-body">
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="rank" id="select_id" class="form-control">
                                ...
                                <option value="1" @if($page->rank ==1)selected @endif>一级标题</option>
                                <option value="2" @if($page->rank ==2)selected @endif>二级标题</option>
                                <option value="3" @if($page->rank ==3)selected @endif>三级标题</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="preid" id="" class="form-control">
                                ...
                                <optgroup label="#一级标签无上级标签" id="1">
                                    <option value="-1" @if($page->preid == -1)selected @endif>无</option>
                                </optgroup>
                                <optgroup label="#从下列一级标签中选取" id="2">
                                    ...
                                    @endphp
                                    @foreach($keys as $key)
                                        <option value="{{$key->id}}" @if($page->preid ==$key->id)selected @endif> {{$key->name}}</option>
                                    @endforeach
                                </optgroup>
